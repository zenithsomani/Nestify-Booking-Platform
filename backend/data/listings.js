const listings = [
  {
    ...
    maxGuests: 4,
    availability: {
      from: new Date("2025-09-23T00:00:00.000Z"),
      to: new Date("2025-09-30T00:00:00.000Z"),
    },
  },
  {
    id: 2,
    ...
    availability: {
      from: new Date("2025-09-23T00:00:00.000Z"),
      to: new Date("2025-10-07T00:00:00.000Z"),
    },
  },
  {
    id: 3,
    ...
    availability: {
      from: new Date("2025-09-23T00:00:00.000Z"),
      to: new Date("2025-10-14T00:00:00.000Z"),
    },
  },
  {
    id: 4,
    ...
    availability: {
      from: new Date("2025-09-23T00:00:00.000Z"),
      to: new Date("2025-10-21T00:00:00.000Z"),
    },
  },
  {
    id: 5,
    ...
    description:
      "This modern apartment is located in the heart of London, just a few minutes' walk from the nearest metro station. It has a large living room with a fireplace, a fully equipped kitchen, and a dining area. The apartment has two bedrooms and two bathrooms.\n\nThe apartment is located in a quiet residential area, but it is still close to many restaurants, cafes, and shops. It is also close to the British Museum and the National Gallery.\n\nIf you need any help during your stay, we will be happy to assist you. We look forward to welcoming you to London!",
    location: "London",
    images: [
      "listing5-1.jpg",
      "listing5-2.jpg",
  ...
  // Last 4 listings (9–12)
  {
    id: 9,
    name: "Elegant Penthouse in London",
    description:
      "An elegant penthouse located in central London, with stunning city views, a modern kitchen, and luxurious furnishings. Perfect for a sophisticated stay in the city.",
    location: "London",
    images: [
      "listing9-1.jpg",
      "listing9-2.jpg",
  ...
  {
    id: 10,
    name: "Modern Studio in Paris",
    description:
      "A sleek modern studio in the heart of Paris, close to major attractions, with a cozy bed, kitchenette, and modern bathroom.",
    location: "Paris",
    images: [
      "listing10-1.jpg",
      "listing10-2.jpg",
  ...
  {
    id: 11,
    name: "Family House in London",
    description:
      "A large family house in London with 4 bedrooms, 3 bathrooms, and a fully equipped kitchen. Perfect for family stays.",
    location: "London",
    images: [
      "listing11-1.jpg",
      "listing11-2.jpg",
  ...
  {
    id: 12,
    name: "Luxury Loft in Paris",
    description:
      "A luxurious loft in Paris with a modern design, spacious living area, and fully equipped kitchen. Ideal for couples or small groups.",
    location: "Paris",
    images: [
      "listing12-1.jpg",
      "listing12-2.jpg",
